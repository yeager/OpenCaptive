...
static void test_original_visual_scans(void) {
    ...
    assert(scan_for_visual_action(CAPTIVE_NAV_ACTION_UP) == 0x48);
    assert(scan_for_visual_action(CAPTIVE_NAV_ACTION_DOWN) == 0x50);
    assert(scan_for_visual_action(CAPTIVE_NAV_ACTION_LEFT) == 0x4B);
    assert(scan_for_visual_action(CAPTIVE_NAV_ACTION_RIGHT) == 0x4D);

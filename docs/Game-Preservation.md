...
> Documentation baseline: v1.1.111. OpenCaptive uses player-supplied original media and content hashes rather than bundling game data.
...
- **ADF disk images**: 880 KB (DD) standard Amiga floppy format, 80 tracks x 2 sides x 11 sectors x 512 bytes
- **LZEXE compression**: CAPPO.EXE uses LZEXE v0.91; unpacked SHA-256: `fa7d5ca76d26f614476ed41f27cf737084942e9216b20b4605734df9ede9aee4`
- **ZIP archive support**: OpenCaptive scans ZIP archives with nested file discovery, identifying game resources by SHA-256 regardless of archive structure or filenames
- **Atari ST**: FAT12 disk images with BIOS parameter block at offset 11
...
- **ADF disk images**: 880 KB (DD) for floppy release, 1760 KB (HD) not used
- **ISO 9660**: CD32 data track in MODE1/2352 raw sectors with CDTV extensions
- **Red Book audio**: 10 CD audio tracks (Track 02-11) by Mark Knight
...
### No original data distributed

Original game data is never committed to the repository, bundled in releases, or emitted by tools. All content is addressed by SHA-256 — the engine locates and verifies resources by their cryptographic hash, never by filename or path.

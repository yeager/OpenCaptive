 ...
 * Weapon damage: lo/hi bytes from melee_damage[] (0x1A006) and ranged_damage[]
 * tables, stored as damage_min=lo, damage_max=hi for the encoded combat formula.
 * Price: from upgrade_tiers[] (0x1A220). Weight: type_code dependent. */
static const Item item_defs[] = {
    /* Body parts — type 0x27 (ARM uses 0x65), all grade 0x05 */
    /*                                          tc  dmin dmax def rng tier ammo amx  price  wt   sk */
    { 1, ITEM_ARMOR_HEAD,  "HEAD",             0x27, 0,  0,  10, 0, 0,  0, 0,  100, 1.0f, 0},
    { 2, ITEM_ARMOR_CHEST, "CHEST",            0x27, 0,  0,  15, 0, 0,  0, 0,  100, 1.0f, 0},
    { 3, ITEM_ARMOR_ARM,   "ARM",              0x65, 0,  0,   8, 0, 0,  0, 0,   80, 1.0f, 0},
    { 4, ITEM_ARMOR_LEG,   "LEG",              0x27, 0,  0,   8, 0, 0,  0, 0,   80, 1.0f, 0},
    { 5, ITEM_ARMOR_FOOT,  "FOOT",             0x27, 0,  0,   5, 0, 0,  0, 0,   60, 1.0f, 0},
    { 6, ITEM_ARMOR_HAND,  "HAND",             0x27, 0,  0,   5, 0, 0,  0, 0,   60, 1.0f, 0},
    ...
    /* Melee weapons — damage lo/hi from melee_damage[] at 0x1A006.
     * Each weapon base has 4 grade variants in the table; we use grade 0 (first). */
    {13, ITEM_WEAPON_MELEE, "KNUCLE-DUSTER",   0x00, 0x04,0x21, 0,1, 0, 0,0,   19, 0.5f, 0},
    {14, ITEM_WEAPON_MELEE, "BATTLE-GLOVE",    0x21, 0x4C,0x21, 0,1, 0, 0,0,   50, 0.5f, 0},
    {15, ITEM_WEAPON_MELEE, "WAR-BLADE",       0x21, 0x15,0x21, 0,1, 0, 0,0,  100, 1.0f, 1},
    {16, ITEM_WEAPON_MELEE, "LIGHT-BLADE",     0x21, 0x5A,0x21, 0,1, 0, 0,0,  200, 0.8f, 1},
    {17, ITEM_WEAPON_MELEE, "FIRE-AXE",        0x21, 0x13,0x45, 0,1, 0, 0,0,  150, 2.0f, 1},

    /* Handguns — damage from ranged_damage[]: base/modifier encode lo/hi */
    {18, ITEM_WEAPON_HANDGUN, "PISTOL",        0x21, 72, 45,   0,6, 0, 0,0,  400, 1.0f, 2},
    {19, ITEM_WEAPON_HANDGUN, "COLT",          0x30, 88, 45,   0,6, 0, 0,0,  600, 1.2f, 2},
    {20, ITEM_WEAPON_HANDGUN, "MAGNUM",        0x30,104, 45,   0,6, 0, 0,0,  800, 1.5f, 3},

    /* Rifles — ranged_damage[4..7] */
    {21, ITEM_WEAPON_RIFLE, "RIFLE",           0x30, 72, 35,   0,6, 1, 0,0,  700, 2.5f, 3},
    {22, ITEM_WEAPON_RIFLE, "SHOTGUN",         0x30, 88, 35,   0,6, 1, 0,0,  900, 3.0f, 3},
    {23, ITEM_WEAPON_RIFLE, "HUNTER",          0x30,104, 35,   0,6, 1, 0,0, 1100, 3.5f, 4},

    /* Automatics — ranged_damage[8..11] */
    {24, ITEM_WEAPON_AUTO,  "UZIE",            0x30, 72, 25,   0,6, 2, 0,0,  800, 2.0f, 4},
    {25, ITEM_WEAPON_AUTO,  "RAPEDO",          0x30, 88, 25,   0,6, 2, 0,0, 1200, 2.5f, 5},
    {26, ITEM_WEAPON_AUTO,  "BOOSTER",         0x30,104, 25,   0,6, 2, 0,0, 1500, 3.0f, 5},

    /* Energy weapons — ranged_damage[12..15] */
    {27, ITEM_WEAPON_LASER, "HAND-LASER",      0x30, 72, 15,   0,6, 3, 0,0, 1500, 1.5f, 6},
    {28, ITEM_WEAPON_LASER, "LYTE-ZAPPER",     0x30, 88, 15,   0,6, 3, 0,0, 2000, 2.0f, 7},
    {29, ITEM_WEAPON_LASER, "ION-PULSE",       0x30,104, 15,   0,6, 3, 0,0, 2500, 2.5f, 8},

    /* Heavy weapons — ranged_damage[16..19] */
    {30, ITEM_WEAPON_CANNON, "MONO-CANNON",    0x30, 72,  5,   0,6, 4, 0,0, 2000, 8.0f, 7},
    {31, ITEM_WEAPON_CANNON, "A51-LAUNCHER",   0x30, 88,  5,   0,6, 4, 0,0, 3000,10.0f, 8},
    {32, ITEM_WEAPON_CANNON, "TWIN-CANNON",    0x30,104,  5,   0,6, 4, 0,0, 3500,10.0f, 7},
    {33, ITEM_WEAPON_SPRAY,  "AIROSOLL",       0x30,120, 45,   0,4, 3, 0,0, 1200, 4.0f, 5},
    {34, ITEM_WEAPON_SPRAY,  "ACID-DISPERSER", 0x30,120, 35,   0,4, 3, 0,0, 1800, 5.0f, 6},
    {35, ITEM_WEAPON_SPRAY,  "FLAME-THROWER",  0x30,120, 25,   0,4, 4, 0,0, 2200, 5.5f, 7},

    /* Weapon variant prefixes — type 0x30 */
    {36, ITEM_WEAPON_AUTO,   "A12-",           0x30, 88, 25,   0,6, 2, 0,0, 1000, 3.0f, 5},
    {37, ITEM_WEAPON_LASER,  "L22-",           0x30, 88, 15,   0,6, 3, 0,0, 1800, 2.5f, 7},
    {38, ITEM_WEAPON_CANNON, "X42-2-",         0x30,104,  5,   0,6, 4, 0,0, 2800, 8.0f, 8},

...
Pre-built packages for all platforms are available on the [Releases](https://github.com/yeager/OpenCaptive/releases) page. Maintainers can also run the **Release** GitHub Actions workflow manually with a version such as `1.1.90`; tag-based releases remain supported.
...
61 tests covering format decoders, game logic, combat, save/load, map generation, audio, rendering, UI, localization catalogs, and release-version consistency.
...
tests/        61 test source files (61 CTest targets)

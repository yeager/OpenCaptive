...
Pre-built packages for all platforms are available on the [Releases](https://github.com/yeager/OpenCaptive/releases) page. Maintainers can also run the **Release** GitHub Actions workflow manually with a version such as `1.1.106`; tag-based releases remain supported.
...
64 tests covering format decoders, game logic, combat, save/load, map generation, audio, rendering, UI, localization catalogs, and release-version consistency.

...
typedef struct {
    ...
    /* Authenticated CAPPO frame at the real Mission 0001 target cursor. */
    const uint8_t *target_reference;
    int target_reference_width, target_reference_height;
    int target_cursor_x, target_cursor_y;
    bool target_cursor_valid;
} Holamap;
...
/* Select a complete frame captured from CAPPO when the real target cursor is
 * reached. No marker or map pixels are generated by this selection. */
